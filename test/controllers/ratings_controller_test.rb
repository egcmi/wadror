...
class RatingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create rating" do
    assert_difference('Rating.count') do
      post ratings_url, params: { rating: { beer_id: @rating.beer_id, score: @rating.score } }
    end
  ...
  test "should update rating" do
    patch rating_url(@rating), params: { rating: { beer_id: @rating.beer_id, score: @rating.score } }
